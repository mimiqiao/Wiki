...
const BLOG = {
  ...
  NOTION_PAGE_ID:
      process.env.NOTION_PAGE_ID || '70e3a635b2ff40b4bdb9ce8412b80405',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Way to AGI Wiki', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'A wiki of AI and AGI', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://en.waytoagi.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'blog, AI, AGI, wiki, OpenAI, Google, Microsoft, transformer, LLM', // 网站关键词 英文逗号隔开
