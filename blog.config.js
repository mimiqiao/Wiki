...
const BLOG = {
  ...
  TRANSITION_ANIMATION: process.env.NEXT_PUBLIC_TRANSITION_ANIMATION || true, // 切换页面的淡入淡出动画
  ...
  ENABLE_CACHE: process.env.ENABLE_CACHE || true, // 开启缓存会将Notion数据缓存在内存中，通常在开发调试中使用，正式部署开启此功能意义不大。
